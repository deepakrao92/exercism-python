...
def exchangeable_value(budget : float, exchange_rate : float, spread : int, denomination : int):
    ...
    # print(exchange_rate_with_spread)
    exchaned_amount = exchange_money(budget, exchange_rate_with_spread)
    # print(exchaned_amount)

    return int(get_number_of_bills(exchaned_amount, denomination) * denomination)
